<?php
    ...
    include 'com.qlnhasach.dao/output.php';
    $xuat = new output();
    $xuatList = $xuat->show_orders_product();
...
?>
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-7 text-right m-b-30">
                        <a href="output.php" class="btn btn-primary btn-rounded float-right"><img width="20px" src="assets/img/logout.png"> Xuất</a>
                    </div>
                </div>
                <div class="row filter-row">
                    <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                        <div class="form-group form-focus">
                            <label class="focus-label">Tên sách</label>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table mb-0 datatable">
                                ...
                                $dem=1;
                                        if ($xuatList) {
                                            foreach ($xuatList as $ip) {
                                                echo '<tr>';
                                                echo '<td>' . $dem. '</td>';
                                                echo '<td>' . $ip['productname'] . '</td>';
                                                echo '<td>' . $ip['total_product'] . '</td>';
                                                echo '<td>' . $ip['price'] . '</td>';
                                                echo '<td>' . $ip['total_product'] * $ip['price']. '</td>';
                                                echo '<td>' . $ip['output_date'] . '</td>';
                                                echo '<td>' . $ip['sold_by'] . '</td>';
                                                echo '<td>' . $ip['ghichu'] . '</td>';
                                                echo '</tr>';
                                                $dem++;
                                            }
                                        } else {
            ...
            <div class="modal" id="errorModal">
                <div class="modal-content">
                    <h2>Lỗi</h2>
                    <p id="errorMessage">Trong kho chỉ còn <span id="inventoryAmount"></span>, không thể xuất nhiều hơn!</p>
    ...
    <script>
        function openErrorModal(inventoryAmount) {
            var modal = document.getElementById("errorModal");
            var errorMessage = document.getElementById("errorMessage");
            var inventoryAmountSpan = document.getElementById("inventoryAmount");
            inventoryAmountSpan.textContent = inventoryAmount;
