<?php
    ...
    if(isset($_POST['add_employees'])){
        ...
        $status = $_POST['status'];
        $result = $nguoidungModel->insert_nguoidung($username, $fullname, $email, $phone_number, $address, $password, $role_name, $status);
    }
?>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST"  action="add-employee.php">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="add_employees">Thêm người dùng</button>
                            </div>
                        </form>
                    </div>
                </div>
