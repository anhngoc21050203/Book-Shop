<?php
    ...
    if(isset($_POST['add_category'])){
        ...
        $result = $categoryModel->insert_cartegory($categoryName, $categoryCode);
    }
    if ($result) {
...
?>
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" autocomplete="off" action="add-category.php">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" type="submit" name="add_category">Thêm thể loại</button>
                            </div>
                        </form>
                    </div>
                </div>
